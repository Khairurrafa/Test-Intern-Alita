<x-layout>
    <div class="w-full mx-auto max-w-screen-xl pt-28">
        <h1 class="text-4xl font-bold text-gray-800">Tambah Data Karyawan</h1>
    </div>


    <form class="max-w-sm mx-auto pt-10"  action="{{ route('employees.store') }}" method="POST">
      @csrf
      <div class="mb-5">
